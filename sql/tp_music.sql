...
(
    ...
    `name`        varchar(45)      NOT NULL default '' comment '登录名',
...
/*!40000 ALTER TABLE `admin`
    DISABLE KEYS */;
INSERT INTO `admin`
VALUES (1, 'admin', '123', current_timestamp),
       (2, 'admin1', '123', current_timestamp);
/*!40000 ALTER TABLE `admin`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
    ...
    `type`         tinyint(4)       NOT NULL default 0 comment '类型，0：歌曲，1：歌单',
    `song_id`      int(10) unsigned NOT NULL DEFAULT 0 comment '歌曲id',
    `song_list_id` int(10) unsigned NOT NULL DEFAULT 0 comment '歌单id',
    `create_time`  datetime         NOT NULL default current_timestamp comment '创建时间',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 53
  DEFAULT CHARSET = utf8 comment '收藏';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `collect`
    DISABLE KEYS */;
INSERT INTO `collect`
VALUES (2, 1, 0, 21, 0, '2019-01-07 03:17:42'),
       (3, 94, 0, 22, 0, '2019-01-07 16:38:23'),
       (4, 94, 0, 23, 0, '2019-01-07 16:41:44'),
       (6, 94, 0, 21, 0, '2019-01-07 16:43:45'),
       (10, 94, 0, 3, 0, '2019-01-07 16:58:59'),
       (16, 94, 0, 24, 0, '2019-01-07 17:34:07'),
       (21, 5, 0, 24, 0, '2019-01-08 15:18:33'),
       (24, 5, 0, 8, 0, '2019-01-08 16:07:57'),
       (37, 1, 0, 9, 0, '2019-04-24 18:10:51'),
       (41, 1, 0, 16, 0, '2019-04-24 18:14:31'),
       (42, 1, 0, 17, 0, '2019-04-24 18:14:35'),
       (43, 5, 0, 7, 0, '2019-04-26 01:06:20'),
       (45, 26, 0, 44, 0, '2020-03-21 22:26:37'),
       (46, 26, 0, 36, 0, '2020-03-21 22:28:24'),
       (47, 26, 0, 69, 0, '2020-03-22 01:56:54'),
       (48, 26, 0, 45, 0, '2020-03-22 02:08:36'),
       (49, 26, 0, 21, 0, '2020-03-22 02:08:41'),
       (50, 26, 0, 100, 0, '2020-03-22 03:41:14'),
       (51, 1, 0, 22, 0, '2020-04-05 20:07:09'),
       (52, 12, 0, 99, 0, '2020-04-05 21:19:06');
/*!40000 ALTER TABLE `collect`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
    ...
    `create_time`  datetime         NOT NULL default current_timestamp comment '创建时间',
    `type`         tinyint(4)       NOT NULL default 0 comment '类型，0：歌曲，1：歌单',
    `up`           int(10) unsigned NOT NULL DEFAULT 0 comment '点赞，1：点赞',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 58
...
VALUES (3, 1, 0, 1, '里面乱乱糟糟\n我们别再闹了\n这个冬天已然很冷了\n我们靠在一起。好吗', '2019-01-06 16:12:13', 1, 1),
       (5, 1, 21, 0, '允儿牵动我的心!!!', '2019-01-06 18:12:53', 0, 0),
       (9, 1, 22, 0,
       ...
       (10, 1, 21, 0, '像我们之间一段长久未诉的告白，被你这样娓娓道来，你问我爱你有多深，我爱你有几分，我的情不移我的爱不变，月亮代表我的心。', '2019-01-06 19:44:37', 0, 3),
       (11, 1, 21, 0, '当听这首歌曲的时候，看看天上的月亮。美爆了！', '2019-01-06 19:45:51', 0, 0),
       (12, 1, 23, 0, '太尼马好听了！堂堂正正的林歌手！！', '2019-01-06 19:48:25', 0, 0),
       (13, 1, 23, 0, '林允儿啊，真的唱的很标准，很动人，我的同学都没想到是林允儿唱的，呜呜呜，爱死你了林允儿', '2019-01-06 19:54:01', 0, 0),
       (14, 1, 22, 0, '真的好棒，我只听她这个版本的', '2019-01-06 19:55:43', 0, 0),
       (16, 1, 5, 0, '好听啊', '2019-01-06 19:56:52', 0, 0),
       (17, 1, 22, 0, '我的允宝啊，努力演戏想让我们看到一样的你，努力学中文唱给我们听越来越爱你了', '2019-01-06 19:58:53', 0, 0),
       (18, 1, 22, 0, '好听啊', '2019-01-06 20:01:46', 0, 0),
       (19, 1, 23, 0, '好听啊', '2019-01-06 20:03:59', 0, 0),
       (20, 1, 21, 0, '好听啊', '2019-01-06 20:04:22', 0, 0),
       (23, 1, 0, 5, '赞！！', '2019-01-08 01:05:27', 1, 2),
       (24, 5, 0, 1, '超喜欢！', '2019-01-08 21:46:29', 1, 0),
       (25, 5, 0, 5, '大爱我林！', '2019-01-08 21:47:45', 1, 1),
       (26, 5, 0, 2, 'nice', '2019-01-08 22:11:23', 1, 1),
       (27, 1, 0, 0, '很有感觉', '2019-01-08 22:32:51', 1, 2),
       (28, 5, 26, 0, '好听', '2019-01-08 22:42:07', 0, 0),
       (29, 5, 21, 0, 'nice!', '2019-01-08 22:57:08', 0, 0),
       (30, 5, 15, 0, '好听！', '2019-01-08 23:03:43', 0, 0),
       (31, 1, 13, 0, 'rrrr', '2019-01-15 16:28:03', 0, 0),
       (32, 1, 19, 0, '赞', '2019-03-07 16:34:12', 0, 0),
       (33, 1, 6, 0, '赞', '2019-03-12 09:06:21', 0, 0),
       (34, 1, 0, 1, 'hao', '2019-03-16 21:07:01', 1, 0),
       (35, 1, 0, 38, 'hao', '2019-03-24 01:39:06', 1, 0),
       (36, 1, 0, 0, '妙！', '2019-03-24 01:48:56', 1, 1),
       (37, 1, 0, 80, '好听', '2019-03-24 01:51:02', 1, 0),
       (38, 1, 0, 80, '好听！！！', '2019-03-24 01:52:20', 1, 0),
       (39, 1, 0, 80, '好听', '2019-03-24 01:53:06', 1, 0),
       (40, 1, 0, 80, 'good', '2019-03-24 01:53:45', 1, 0),
       (41, 1, 0, 80, 'nice', '2019-03-24 01:55:04', 1, 0),
       (42, 1, 0, 80, 'nice', '2019-03-24 01:57:02', 1, 0),
       (43, 1, 0, 82, 'success', '2019-03-24 01:57:40', 1, 0),
       (45, 1, 0, 1, '啦啦啦(*≧∀≦)ﾉ', '2019-04-25 21:24:43', 1, 0),
       (46, 1, 21, 0, '111', '2019-04-26 00:51:18', 0, 0),
       (47, 1, 0, 1, '222', '2019-04-26 01:01:27', 1, 0),
       (48, 5, 0, 10, '我喜欢你', '2019-04-26 01:03:12', 1, 0),
       (49, 1, 0, 0, '', '2019-05-23 21:35:47', 1, 0),
       (50, 1, 0, 51, '好听', '2019-05-23 21:38:04', 1, 0),
       (51, 1, 0, 5, '好听', '2019-05-23 21:39:55', 1, 0),
       (52, 1, 0, 5, '好听', '2019-05-23 21:40:25', 1, 0),
       (53, 1, 107, 0, 'I love you！！！', '2019-06-03 02:16:23', 0, 0),
       (54, 1, 95, 0, '好听', '2020-03-14 16:14:53', 0, 0),
       (55, 1, 28, 0, '?', '2020-03-14 16:19:11', 0, 0),
       (56, 26, 69, 0, 'good!', '2020-03-22 02:19:03', 0, 0),
       (57, 26, 10, 0, 'good', '2020-03-22 03:40:10', 0, 3);
/*!40000 ALTER TABLE `comment`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
    ...
    `phone_num`    char(15)         NOT NULL DEFAULT '' comment '手机号',
    `email`        char(30)         NOT NULL DEFAULT '' comment '邮箱',
    `birth`        datetime         NOT NULL DEFAULT '1970-01-01' comment '生日',
    `introduction` varchar(255)     NOT NULL DEFAULT '' comment '签名',
    `location`     varchar(45)      NOT NULL DEFAULT '' comment '地址',
    `avatar`       varchar(255)     NOT NULL DEFAULT '' comment '头像',
    `create_time`  datetime         NOT NULL default current_timestamp comment '创建时间',
    `update_time`  datetime         NOT NULL default current_timestamp on update current_timestamp comment '更新时间',
    PRIMARY KEY (`id`),
    unique KEY `user_name_unique` (`username`),
    KEY `phone_num_key` (`phone_num`),
    KEY `email_key` (`email`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 29
...
VALUES (1, 'Yin', '123', 0, '13776412237', 'yoona@qq.com', '2019-05-24 00:00:00', '好好吃饭', '山西',
       ...
       (8, 'tawuhen', '123', 0, '13634377256', '192673541@qq.com', '2019-04-25 18:58:39', '你好', '北京',
        '/img/avatarImages/user.jpg',
        '2019-04-25 00:28:58', '2019-04-25 18:58:39'),
       ...
       (21, 'yoonaA', '123', 1, '15754801258', '', '2020-03-25 00:00:00', '', '', '/img/avatarImages/user.jpg',
        '2020-03-21 22:18:33', '2020-03-21 22:18:33'),
       (24, 'yoonaAA', '123', 1, '15754801259', '', '2020-03-04 00:00:00', '', '', '/img/avatarImages/user.jpg',
        '2020-03-21 22:20:27', '2020-03-21 22:20:27'),
       (25, 'yoonaAB', '123', 1, '15754801212', '', '2020-03-02 00:00:00', '', '', '/img/avatarImages/user.jpg',
        '2020-03-21 22:21:50', '2020-03-21 22:21:50'),
       (26, 'yoonaAC', '123', 1, '15754801213', '', '2020-03-11 00:00:00', '', '', '/img/avatarImages/user.jpg',
        '2020-03-21 22:23:43', '2020-04-05 03:30:34'),
       (27, 'yoonaAD', '123', 1, '15754801214', '', '2020-03-11 00:00:00', '', '', '/img/avatarImages/user.jpg',
        '2020-03-21 22:24:47', '2020-03-21 22:24:47'),
       (28, 'yoona90', '123', 0, '15754801216', '', '2020-04-28 00:00:00', '', '', '/img/avatarImages/user.jpg',
...
(
  ...
  AUTO_INCREMENT = 210
  DEFAULT CHARSET = utf8 comment '歌曲和歌单关联表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
    ...
    `song_list_id` bigint(20) unsigned NOT NULL DEFAULT 0 comment '歌单id',
    `consumer_id`  bigint(20) unsigned NOT NULL DEFAULT 0 comment '用户id',
...
/*!40000 ALTER TABLE `rank`
    DISABLE KEYS */;
INSERT INTO `rank`
VALUES (1, 2, 1, 7, current_timestamp),
       (2, 2, 2, 3, current_timestamp),
       (3, 1, 1, 4, current_timestamp),
       (7, 13, 1, 5, current_timestamp),
       (19, 21, 1, 5, current_timestamp),
       (20, 31, 1, 5, current_timestamp),
       (21, 5, 1, 0, current_timestamp),
       (24, 11, 1, 4, current_timestamp),
       (25, 10, 1, 10, current_timestamp),
       (27, 6, 1, 6, current_timestamp),
       (28, 7, 1, 10, current_timestamp),
       (29, 1, 26, 4, current_timestamp),
       (30, 7, 26, 2, current_timestamp),
       (32, 3, 26, 5, current_timestamp),
       (33, 14, 26, 9, current_timestamp);
/*!40000 ALTER TABLE `rank`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
    ...
    `sex`          tinyint(4)       NOT NULL DEFAULT -1 comment '性别，0：女，1：男',
    `pic`          varchar(255)     NOT NULL DEFAULT '' comment '头像图片',
    `birth`        datetime         NOT NULL DEFAULT '1970-01-01' comment '生日',
    `location`     varchar(45)      NOT NULL DEFAULT '' comment '地址',
  ...
  AUTO_INCREMENT = 44
  DEFAULT CHARSET = utf8 comment '歌手';
/*!40101 SET character_set_client = @saved_cs_client */;
...
VALUES (1, '张杰', 1, '/img/singerPic/zhangjie.jpg', '1982-12-20 18:50:07', '中国四川',
       ...
       (41, 'Tone Damli Aaberge', 0, '/img/singerPic/1586091104616Tone Damli Aaberge.jpg', '1988-04-12 00:00:00', '挪威',
...
(
    `id`           int(10) unsigned NOT NULL AUTO_INCREMENT comment '主键',
    `singer_id`    int(10) unsigned NOT NULL DEFAULT 0 comment '歌手id',
    `name`         varchar(45)      NOT NULL DEFAULT '' comment '歌曲名称',
    `introduction` varchar(255)     NOT NULL DEFAULT '' comment '歌曲简介',
    `create_time`  datetime         NOT NULL default current_timestamp COMMENT '发行时间',
    `update_time`  datetime         NOT NULL default current_timestamp on update current_timestamp comment '更新时间',
    `pic`          varchar(255)     NOT NULL DEFAULT '' comment '歌曲图片',
    `lyric`        text comment '歌词',
    `url`          varchar(255)     NOT NULL DEFAULT '' comment '地址',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 124
  DEFAULT CHARSET = utf8 COMMENT '发行时间';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `song`
    DISABLE KEYS */;
INSERT INTO `song`
VALUES (1, 1, '张杰-仰望星空', '明天过后', '2018-12-26 08:40:14', '2019-04-25 20:14:20', '/img/songPic/haikuotiankong.jpg',
       ...
       (3, 1, '张杰-天下', '明天过后', '2018-12-26 11:34:31', '2018-12-26 11:34:31', '/img/songPic/haikuotiankong.jpg',
        ...
        '/song/张杰-天下.mp3'),
       (4, 1, '张杰-如果爱', '再爱我一回', '2018-12-26 11:47:15', '2019-04-24 21:13:52', '/img/songPic/haikuotiankong.jpg',
        ...
        '/song/张杰-如果爱.mp3'),
       (5, 1, '张杰-逆战', '中国新声代第二季 第十三期', '2018-12-26 11:57:04', '2019-04-24 23:09:55', '/img/songPic/nizhan.jpg',
        ...
        '/song/张杰-逆战.mp3'),
       (6, 1, '张杰-逆态度', '中国新声代第二季 第十三期', '2018-12-26 12:02:57', '2018-12-26 12:02:57', '/img/songPic/nizhan.jpg',
        ...
        '/song/张杰-逆态度.mp3'),
       (7, 1, '张杰-何必在一起', '穿越三部曲', '2018-12-27 07:49:53', '2018-12-27 07:49:53', '/img/songPic/hebiyaozaiyiqi.jpg',
       ...
       (9, 2, '周杰伦-稻香', '魔杰座', '2018-12-27 08:17:12', '2018-12-27 08:17:12', '/img/songPic/daoxiang.jpg',
        ...
        '/song/周杰伦-稻香.mp3'),
       (10, 2, '周杰伦&潘儿-夜的第七章', '依然范特西', '2018-12-27 08:26:27', '2018-12-27 08:26:27', '/img/songPic/yedediqizhang.jpg',
       ...
       (11, 2, '周杰伦-告白气球', '床边故事', '2018-12-27 08:45:24', '2018-12-27 08:45:24', '/img/songPic/gaobaiqiqui.jpg',
       ...
       (12, 2, '周杰伦-夜曲', '床边故事', '2018-12-30 02:11:23', '2018-12-30 02:11:23', '/img/songPic/gaobaiqiqui.jpg',
        ...
        '/song/周杰伦-夜曲.mp3'),
       (13, 2, '周杰伦-红尘客栈', '十二新作', '2018-12-30 02:23:53', '2018-12-30 02:23:53', '/img/songPic/hongchengkezhan.jpg',
       ...
       (15, 2, '周杰伦-菊花台', '依然范特西', '2018-12-30 02:42:47', '2018-12-30 02:42:47', '/img/songPic/juhuatai.jpg',
        ...
        '/song/周杰伦-菊花台.mp3'),
       (16, 2, '周杰伦-牛仔很忙', '我很忙', '2018-12-30 02:48:47', '2018-12-30 02:48:47', '/img/songPic/nuizaihenmang.jpg',
        ...
        '/song/周杰伦-牛仔很忙.mp3'),
       (17, 2, '周杰伦-烟花易冷', '跨时代', '2018-12-30 02:57:23', '2018-12-30 02:57:23', '/img/songPic/yanhuayileng.jpg',
        ...
        '/song/周杰伦-烟花易冷.mp3'),
       (18, 2, '周杰伦-听妈妈的话', '依然范特西', '2018-12-30 03:08:45', '2018-12-30 03:08:45', '/img/songPic/yanhuayileng.jpg',
       ...
       (20, 2, '周杰伦-晴天', '叶惠美', '2018-12-30 03:17:20', '2018-12-30 03:17:20', '/img/songPic/qingtian.jpg',
        ...
        '/song/周杰伦-晴天.mp3'),
       (21, 3, '林允儿-月亮代表我的心', 'Blossom', '2018-12-30 03:26:32', '2018-12-30 03:26:32', '/img/songPic/Blossom.jpg',
        '[00:00.00] 作曲 : 翁清溪\n[00:01.00] 作词 : 孙仪\n[00:09.54]编曲 : 이재명\n[00:11.67]你问我爱你有多深　\n[00:17.32]我爱你有几分\n[00:22.72]我的情也真　\n[00:25.49]我的爱也真　\n[00:28.39]月亮代表我的心\n[00:34.02]\n[00:34.46]你问我爱你有多深　\n[00:40.13]我爱你有几分\n[00:45.51]我的情不移　\n[00:48.56]我的爱不变　\n[00:51.26]月亮代表我的心\n[00:56.25]\n[00:56.92]轻轻的一个吻\n[01:02.74]已经打动我的心\n[01:08.43]深深的一段情　\n[01:14.13]叫我思念到如今\n[01:19.23]\n[01:20.11]你问我爱你有多深　\n[01:25.81]我爱你有几分\n[01:31.23]你去想一想\n[01:34.11]你去看一看　\n[01:36.92]月亮代表我的心\n[01:42.08]\n[01:54.15]轻轻的一个吻\n[01:59.83]已经打动我的心\n[02:05.59]深深的一段情　\n[02:11.21]叫我思念到如今\n[02:16.62]\n[02:17.27]你问我爱你有多深　\n[02:23.10]我爱你有几分\n[02:28.40]你去想一想\n[02:31.25]你去看一看　\n[02:34.16]月亮代表我的心\n[02:38.92]\n[02:39.76]你去想一想\n[02:42.66]你去看一看　\n[02:45.56]月亮代表我的心\n[03:03.30]',
       ...
       (26, 4, '陈奕迅-不要说话', '不想放手', '2018-12-30 08:30:03', '2018-12-30 08:30:03', '/img/songPic/buyaoshuohua.jpg',
       ...
       (28, 5, 'G.E.M.邓紫棋-龙卷风', '龙卷风', '2018-12-30 08:48:44', '2018-12-30 08:48:44', '/img/songPic/longjuanfeng.jpg',
       ...
       (31, 6, '梁耀燮-리본(Ribbon)', 'Highlight', '2018-12-30 09:59:49', '2018-12-30 09:59:49', '/img/songPic/Ribbon.jpg',
       ...
       (39, 9, '林俊杰-期待爱', 'JJ陆', '2019-03-19 13:44:19', '2019-04-24 22:35:28', '/img/songPic/guanjianci.jpg',
        ...
        '/song/林俊杰-期待爱.mp3'),
       (40, 10, '王力宏-需要人陪', '十八般武艺', '2019-03-19 13:52:02', '2019-03-19 13:52:02', '/img/songPic/xuyaorenpei.jpg',
       ...
       (46, 12, '李荣浩 - 年少有为', '耳朵', '2019-06-02 18:39:02', '2019-06-02 18:39:02', '/img/songPic/lironghao.jpg',
        ...
        '/song/李荣浩-年少有为.mp3'),
       (47, 10, '王力宏-大城小爱', '盖世英雄', '2019-06-02 18:41:59', '2019-06-02 18:41:59', '/img/songPic/dachengxiaoai.jpg',
       ...
       (50, 18, '李克勤-护花使者', '护花使者', '2019-06-02 18:51:19', '2019-06-02 18:51:19', '/img/songPic/109951163157531184.jpg',
        ...
        '/song/李克勤-护花使者.mp3'),
       (51, 18, '李克勤-月半小夜曲', '经典金曲', '2019-06-02 19:16:24', '2019-06-02 19:16:24', '/img/songPic/19196373509550737.jpg',
        ...
        '/song/李克勤-月半小夜曲.mp3'),
       (52, 18, '李克勤-K歌之王', '经典金曲', '2019-06-02 19:17:33', '2019-06-02 19:17:33', '/img/songPic/796046418510127.jpg',
        '[00:00:00]暂无歌词', '/song/李克勤-K歌之王.mp3'),
       (53, 12, '李荣浩-李白', '模特', '2019-06-02 19:19:44', '2019-06-02 19:19:44', '/img/songPic/109951163187393370.jpg',
        ...
        '/song/李荣浩-李白.mp3'),
       (54, 12, '李荣浩-作曲家', '李荣浩', '2019-06-02 19:21:29', '2019-06-02 19:21:29', '/img/songPic/3243559303261105.jpg',
        ...
        '/song/李荣浩-作曲家.mp3'),
       (55, 16, '杨宗纬-多余', '昨天今天明天', '2019-06-01 19:45:59', '2019-06-02 18:07:41', '/img/songPic/109951163167487498.jpg',
        '[00:00.00] 暂无歌词', '/song/杨宗纬-多余.mp3'),
       (56, 23, '毛不易-那时的我们', '那时的我们', '2019-06-02 19:23:46', '2019-06-02 19:23:46',
        ...
        '/song/毛不易-那时的我们.mp3'),
       (57, 23, '毛不易-无问', '无问', '2019-06-02 19:24:40', '2019-06-02 19:24:40', '/img/songPic/109951163099854364.jpg',
        ...
        '/song/毛不易-无问.mp3'),
       (58, 19, '张碧晨-一吻之间', '一吻之间', '2019-06-01 20:15:19', '2019-06-02 18:07:27', '/img/songPic/3244658814415290.jpg',
        '[00:00.00] 暂无歌词', '/song/张碧晨-一吻之间.mp3'),
       (59, 19, '张碧晨-下一秒', '微微一笑很倾城', '2019-06-02 19:27:48', '2019-06-02 19:27:48', '/img/songPic/1369991503018202.jpg',
        '[00:00.37]张碧晨 - 下一秒\n[00:02.24]作词：汪苏泷\n[00:06.47]作曲：汪苏泷\n[00:13.22]好想能看到\n[00:16.20]你嘴角微笑\n[00:19.03]最好在下一秒\n[00:25.30]好想能听到\n[00:28.43]你轻声歌唱\n[00:31.42]最好在下一秒\n[00:37.64]纯白棒球帽\n[00:40.63]墨绿色衣角\n[00:43.76]时间静止的美好\n[00:49.98]默契发生在每个下一秒\n[00:56.00]爱上同一种口味的蛋糕\n[01:02.27]不约而同哼唱一段曲调\n[01:08.34]喜欢这样看你傻傻的笑\n[01:14.62]好想能这样\n[01:17.61]就白头到老\n[01:20.60]最好从下一秒\n[01:39.19]好想能看到\n[01:42.22]你嘴角微笑\n[01:45.20]最好在下一秒\n[01:51.38]好想能听到\n[01:54.46]你轻声歌唱\n[01:57.55]最好在下一秒\n[02:03.31]纯白棒球帽\n[02:06.96]墨绿色衣角\n[02:09.79]时间静止的美好\n[02:16.16]默契发生在每个下一秒\n[02:22.37]爱上同一种口味的蛋糕\n[02:28.45]不约而同哼唱一段曲调\n[02:34.72]喜欢这样看你傻傻的笑\n[02:40.69]好想能这样\n[02:43.67]就白头到老\n[02:46.81]最好从下一秒\n[02:53.18]最好从下一秒',
        '/song/张碧晨-下一秒.mp3'),
       (60, 14, '许嵩-我乐意', '我乐意', '2019-06-02 19:35:54', '2019-06-02 19:35:54', '/img/songPic/109951163261278540.jpg',
       ...
       (65, 15, '张国荣-想你', '想你', '2019-06-02 19:42:02', '2019-06-02 19:42:02', '/img/songPic/78065325577772.jpg',
        ...
        '/song/张国荣-想你.m4a'),
       (67, 15, '张国荣-倩女幽魂', '倩女幽魂', '2019-06-02 19:45:39', '2019-06-02 19:45:39', '/img/songPic/78065325577772.jpg',
        '[00:04.11]张国荣 - 倩女幽魂\n[00:07.66]词：黄沾\n[00:07.66]曲：黄沾\n[00:07.66]人生路 美梦似路长\n[00:15.80]路里风霜 风霜扑面干\n[00:24.04]红尘里 美梦有几多方向\n[00:31.82]找痴痴梦幻中心爱\n[00:37.23]路随人茫茫\n[00:42.46]人生是 美梦与热望\n[00:50.44]梦里依稀 依稀有泪光\n[00:58.55]何从何去 去觅我心中方向\n[01:05.95]风仿佛在梦中轻叹\n[01:12.10]路和人茫茫\n[02:40.56]人间路 快乐少年郎\n[02:48.09]路里崎岖 崎岖不见阳光\n[02:56.95]泥尘里 快乐有几多方向\n[03:04.50]一丝丝梦幻般风雨\n[03:09.95]路随人茫茫\n[03:14.64]丝丝梦幻般风雨\n[03:20.07]路随人茫茫',
        '/song/张国荣-倩女幽魂.m4a'),
       (68, 15, '张国荣-最冷一天', '最冷一天', '2019-06-02 12:29:33', '2019-06-02 18:07:22', '/img/songPic/103354093011859.jpg',
        '[00:00.00] 暂无歌词', '/song/张国荣-最冷一天.mp3'),
       (69, 13, '田馥甄-小幸运', '小幸运', '2019-06-02 19:46:36', '2019-06-02 19:46:36', '/img/songPic/109951163520335473.jpg',
       ...
       (73, 30, '五月天-倔强', '倔强', '2019-06-02 19:53:48', '2019-06-02 19:53:48', '/img/songPic/109951163188724796.jpg',
       ...
       (76, 17, '朴树-平凡之路', '平凡之路', '2019-06-02 19:55:55', '2019-06-02 19:55:55', '/img/songPic/18885211718782327.jpg',
        ...
        '/song/朴树-平凡之路.mp3'),
       (77, 17, '朴树-白桦林', '白桦林', '2019-06-02 19:56:38', '2019-06-02 19:56:38', '/img/songPic/18885211718782327.jpg',
        ...
        '/song/朴树-白桦林.mp3'),
       (78, 31, 'Beyond-光辉岁月', '光辉岁月', '2019-06-02 20:00:14', '2019-06-02 20:00:14', '/img/songPic/29686813951246.jpg',
       ...
       (80, 31, 'Beyond-真的爱你', '真的爱你', '2019-06-02 20:02:11', '2019-06-02 20:02:11', '/img/songPic/29686813951246.jpg',
        '[00:00.60]Beyond - 真的爱你\n[00:01.60]词：梁美薇\n[00:02.60]曲：黄家驹\n[00:27.10]无法可修饰的一对手\n[00:30.97]带出温暖永远在背后\n[00:34.07]纵使啰嗦始终关注\n[00:36.00]不懂珍惜太内疚\n[00:39.50]沉醉于音阶她不赞赏\n[00:43.36]母亲的爱却永未退让\n[00:46.52]决心冲开心中挣扎\n[00:48.45]亲恩终可报答\n[00:52.36]春风化雨暖透我的心\n[00:55.51]一生眷顾无言地送赠\n[01:00.18]是你多么温馨的目光\n[01:03.68]教我坚毅望着前路\n[01:06.78]叮嘱我跌倒不应放弃\n[01:12.62]没法解释怎可报尽亲恩\n[01:16.09]爱意宽大是无限\n[01:19.20]请准我说声真的爱你\n[01:37.13]无法可修饰的一对手\n[01:41.04]带出温暖永远在背后\n[01:44.14]纵使啰嗦始终关注\n[01:46.08]不懂珍惜太内疚\n[01:49.59]仍记起温馨的一对手\n[01:53.45]始终给我照顾未变样\n[01:56.59]理想今天终于等到\n[01:58.52]分享光辉盼做到\n[02:02.43]春风化雨暖透我的心\n[02:05.53]一生眷顾无言地送赠\n[02:10.21]是你多么温馨的目光\n[02:13.71]教我坚毅望着前路\n[02:16.87]叮嘱我跌倒不应放弃\n[02:22.66]没法解释怎可报尽亲恩\n[02:26.17]爱意宽大是无限\n[02:29.22]请准我说声真的爱你\n[03:00.06]春风化雨暖透我的心\n[03:03.21]一生眷顾无言地送赠\n[03:07.73]是你多么温馨的目光\n[03:11.34]教我坚毅望着前路\n[03:14.43]叮嘱我跌倒不应放弃\n[03:20.33]没法解释怎可报尽亲恩\n[03:23.79]爱意宽大是无限\n[03:26.83]请准我说声真的爱你\n[03:32.72]是你多么温馨的目光\n[03:36.23]教我坚毅望着前路\n[03:39.38]叮嘱我跌倒不应放弃\n[03:45.22]没法解释怎可报尽亲恩\n[03:48.68]爱意宽大是无限\n[03:51.77]请准我说声真的爱你',
        '/song/Beyond-真的爱你.mp3'),
       (81, 10, '王力宏-唯一', '唯一', '2019-06-02 20:04:32', '2019-06-02 20:04:32', '/img/songPic/4460718673904110.jpg',
       ...
       (82, 9, '林俊杰-一千年以后', '一千年以后', '2019-06-02 20:05:35', '2019-06-02 20:05:35',
        ...
        '/song/林俊杰-一千年以后.mp3'),
       (83, 9, '林俊杰-江南', '江南', '2019-06-02 20:07:10', '2019-06-02 20:07:10', '/img/songPic/109951163187405670.jpg',
        ...
        '/song/林俊杰-江南.mp3'),
       (84, 9, '林俊杰-学不会', '学不会', '2019-06-02 20:08:12', '2019-06-02 20:08:12', '/img/songPic/109951163187405670.jpg',
        '[00:00.90]原唱：林俊杰\n[00:01.10]作词：姚若龙\n[00:01.30]作曲：林俊杰\n[00:01.50]编曲：闫天午\n[00:01.71]制作人：黄怡\n[00:01.96]音乐总监：刘卓\n[00:02.16]音响总监：金少刚\n[00:02.46]吉他：金天、崔万平、高恭鹏\n[00:02.92]键盘：孙梦迪、李海郡、尹岳洋\n[00:03.43]Program：尹岳洋\n[00:03.58]贝斯：李九君\n[00:03.83]鼓手：卢炜、陈志龙\n[00:04.13]打击乐：刘效松\n[00:04.38]和音：朱江、张炜、樊竹青、关冰效\n[00:04.94]弦乐：靳海音®弦乐团\n[00:05.29]音乐混音：周天澈混音团队\n[00:16.73]你的痛苦我都心疼\n[00:18.65]想为你解决\n[00:24.39]挡开流言紧握你手\n[00:26.46]想飞奔往前\n[00:31.01]我相信爱能证明一切\n[00:35.06]够真心会超越时间\n[00:38.86]多付出也多了喜悦\n[00:42.60]让幸福蔓延\n[00:48.72]总是学不会\n[00:52.46]再聪明一点\n[00:56.25]记得自我保护\n[00:58.13]必要时候讲些\n[01:01.06]善意谎言\n[01:04.03]总是学不会\n[01:08.03]真爱也有现实面\n[01:13.69]不是谁情愿\n[01:17.53]就能够解决\n[01:28.48]一次争吵一个心结\n[01:30.24]累积着改变\n[01:35.96]内心疏远足够秒杀\n[01:37.99]外表多浓烈\n[01:42.52]才发现爱不代表一切\n[01:46.51]再真心也会被阻绝\n[01:50.45]这世界天天有诡雷\n[01:54.17]随时会爆裂\n[01:58.17]还是学不会\n[02:02.04]少浪漫一点\n[02:05.94]拼命着想的事\n[02:07.78]未必带来感动\n[02:10.75]或被感谢\n[02:13.63]还是学不会\n[02:17.47]解释我最伤最累\n[02:25.21]痛死都不愿怪谁\n[02:33.55]把每段痴情苦恋\n[02:37.36]在此刻排列面前\n[02:41.21]也感觉不埋怨只怀念\n[02:52.32]总是学不会\n[02:56.18]再聪明一点\n[03:00.03]记得自我保护\n[03:01.86]必要时候讲些\n[03:04.89]善意谎言\n[03:07.87]不是学不会\n[03:11.61]只是觉得爱太美\n[03:19.30]值得去沉醉流泪',
        '/song/林俊杰-学不会.mp3'),
       (85, 9, '林俊杰-醉赤壁', '醉赤壁', '2019-06-02 20:08:45', '2019-06-02 20:08:45', '/img/songPic/109951163187405670.jpg',
       ...
       (88, 38, 'Vince Zhang - G小调的巴赫 (Vince Moonrise Edit)', 'G小调的巴赫', '2019-06-02 22:52:39', '2019-06-02 22:52:39',
        '/img/songPic/109951162991116739.jpg', '[00:00:00]轻音乐', '/song/Vince Zhang - G小调的巴赫 (Vince Moonrise Edit).mp3'),
       (89, 24, '胡歌-忘记时间', '忘记时间', '2019-06-02 20:17:24', '2019-06-02 20:17:24', '/img/songPic/46179488378975.jpg',
        ...
        '/song/胡歌-忘记时间.mp3'),
       (90, 24, '胡歌-逍遥叹', '逍遥叹', '2019-06-02 20:18:26', '2019-06-02 20:18:26', '/img/songPic/109951163240682406.jpg',
        '[00:00.01]胡歌 - 逍遥叹\n[00:02.15]词：Funck\n[00:03.06]曲：Funck\n[00:24.97]岁月难得沉默\n[00:28.29]秋风厌倦漂泊\n[00:31.61]夕阳赖着不走\n[00:34.17]挂在墙头舍不得我\n[00:38.22]昔日伊人耳边话\n[00:41.60]已和潮声向东流\n[00:44.97]再回首往事也随\n[00:48.20]枫叶一片片落\n[00:51.88]爱已走到尽头\n[00:54.85]恨也放弃承诺\n[00:58.32]命运自认幽默想法太多\n[01:02.37]由不得我\n[01:04.91]壮志凌云几分愁\n[01:08.28]知己难逢几人留\n[01:11.54]再回首\n[01:13.25]却闻笑传醉梦中\n[01:19.58]笑叹词穷\n[01:21.65]古痴今狂终成空\n[01:26.09]刀钝刃乏恩断义绝\n[01:29.96]梦方破\n[01:32.83]路荒已叹饱览足迹\n[01:36.56]没人懂\n[01:39.44]多年望眼欲穿过\n[01:42.55]红尘滚滚我没看透\n[01:46.14]自嘲墨尽千情万怨\n[01:49.90]英杰愁\n[01:52.87]曲终人散发花鬓白\n[01:56.60]红颜殁\n[01:59.52]烛残未觉与日争辉\n[02:03.23]图消瘦\n[02:06.11]当泪干血隐狂涌\n[02:09.15]白雪纷飞都成空\n[02:38.49]爱已走到尽头\n[02:41.57]恨也放弃承诺\n[02:44.89]命运自认幽默想法太多\n[02:49.12]由不得我\n[02:51.82]壮志凌云几分愁知己\n[02:55.70]难逢几人留\n[02:58.21]再回首却闻笑传醉梦中\n[03:06.16]笑叹词穷古痴今狂终成空\n[03:12.83]刀钝刃乏恩断义绝梦方破\n[03:19.51]路荒已叹饱览足迹没人懂\n[03:26.12]多年望眼欲穿过\n[03:29.19]红尘滚滚我没看透\n[03:32.85]自嘲墨尽\n[03:34.94]千情万怨英杰愁\n[03:39.48]曲终人散发\n[03:41.94]花鬓白红颜殁\n[03:46.15]烛残未觉\n[03:48.23]与日争辉图消瘦\n[03:52.82]当泪干血隐狂涌\n[03:55.85]白雪纷飞都成空\n[03:59.47]笑叹词穷\n[04:01.50]古痴今狂终成空\n[04:06.16]刀钝刃乏恩断义绝\n[04:09.89]梦方破\n[04:12.75]路荒已叹饱览\n[04:15.69]足迹没人懂\n[04:19.44]多年望眼欲穿过\n[04:22.46]红尘滚滚我没看透\n[04:26.17]自嘲墨尽\n[04:28.30]千情万怨英杰愁\n[04:32.82]曲终人散\n[04:34.93]发花鬓白红颜殁\n[04:39.49]烛残未觉\n[04:41.63]与日争辉图消瘦\n[04:46.13]当泪干血隐狂涌\n[04:49.17]白雪纷飞都成空',
        '/song/胡歌-逍遥叹.mp3'),
       (91, 24, '胡歌-六月的雨', '六月的雨', '2019-06-02 17:34:16', '2019-06-02 18:07:07', '/img/songPic/109951163240682406.jpg',
        '[00:00.00] 暂无歌词', '/song/胡歌-六月的雨.mp3'),
       (92, 25, '陈势安-天后', '天后', '2019-06-02 20:25:37', '2019-06-02 20:25:37', '/img/songPic/109951163272878671.jpg',
        ...
        '/song/陈势安-天后.mp3'),
       (93, 26, '王菲-匆匆那年', '匆匆那年', '2019-06-02 20:26:21', '2019-06-02 20:26:21', '/img/songPic/2542070884980240.jpg',
        '[00:00.60]王菲 - 匆匆那年\n[00:01.60]词：林夕\n[00:02.60]曲：梁翘柏\n[00:28.68]匆匆那年我们\n[00:30.03]究竟说了几遍\n[00:31.49]再见之后再拖延\n[00:34.27]可惜谁有没有\n[00:35.53]爱过不是一场\n[00:36.83]七情上面的雄辩\n[00:39.62]匆匆那年我们\n[00:41.13]一时匆忙撂下\n[00:42.38]难以承受的诺言\n[00:45.49]只有等别人兑现\n[00:51.26]不怪那吻痕还\n[00:53.72]没积累成茧\n[00:56.63]拥抱着冬眠也没能\n[01:00.09]羽化再成仙\n[01:02.25]不怪这一段情\n[01:04.96]没空反复再排练\n[01:07.77]是岁月宽容恩赐\n[01:11.85]反悔的时间\n[01:18.70]如果再见不能红着眼\n[01:21.76]是否还能红着脸\n[01:24.82]就像那年匆促\n[01:26.22]刻下永远一起\n[01:27.62]那样美丽的谣言\n[01:30.03]如果过去还值得眷恋\n[01:33.40]别太快冰释前嫌\n[01:35.95]谁甘心就这样\n[01:39.03]彼此无挂也无牵\n[01:41.69]我们要互相亏欠\n[01:47.15]要不然凭何怀缅\n[01:58.60]匆匆那年我们\n[01:59.85]见过太少世面\n[02:01.00]只爱看同一张脸\n[02:04.07]那么莫名其妙\n[02:05.47]那么讨人欢喜\n[02:06.78]闹起来又太讨厌\n[02:09.84]相爱那年活该\n[02:11.14]匆匆因为我们\n[02:12.84]不懂顽固的诺言\n[02:15.36]只是分手的前言\n[02:21.16]不怪那天太冷\n[02:23.82]泪滴水成冰\n[02:26.73]春风也一样没\n[02:29.39]吹进凝固的照片\n[02:32.20]不怪每一个人\n[02:35.06]没能完整爱一遍\n[02:37.97]是岁月善意落下\n[02:41.93]残缺的悬念\n[02:48.82]如果再见不能红着眼\n[02:51.68]是否还能红着脸\n[02:54.88]就像那年匆促\n[02:56.09]刻下永远一起\n[02:57.35]那样美丽的谣言\n[02:59.91]如果过去还值得眷恋\n[03:03.12]别太快冰释前嫌\n[03:05.94]谁甘心就这样\n[03:08.90]彼此无挂也无牵\n[03:11.25]如果再见不能红着眼\n[03:14.11]是否还能红着脸\n[03:17.27]就像那年匆促\n[03:18.68]刻下永远一起\n[03:19.93]那样美丽的谣言\n[03:22.54]如果过去还值得眷恋\n[03:25.49]别太快冰释前嫌\n[03:28.40]谁甘心就这样\n[03:31.42]彼此无挂也无牵\n[03:34.18]我们要互相亏欠\n[03:39.83]我们要藕断丝连',
        '/song/王菲-匆匆那年.mp3'),
       ...
       (98, 35, '少女时代 - Oh!', 'Oh!', '2019-06-02 17:45:51', '2019-06-02 18:07:01', '/img/songPic/2529976256578329.jpg',
        '[00:00.00] 暂无歌词', '/song/少女时代 - Oh!.mp3'),
       ...
       (105, 29, '胡伟立 - 侠风', '侠风', '2019-06-03 01:33:36', '2019-06-03 01:33:36', '/img/songPic/2537672838499056.jpg',
        '[00:00:00]暂无歌词', '/song/胡伟立 - 侠风.mp3'),
       (106, 29, '胡伟立 - 嬉戏', '嬉戏', '2019-06-03 01:34:22', '2019-06-03 01:34:22', '/img/songPic/2537672838499056.jpg',
        '[00:00:00]暂无歌词', '/song/胡伟立 - 嬉戏.mp3'),
       ...
       (110, 29, '胡伟立 - 太极乐', '太极乐', '2019-06-03 01:37:45', '2020-04-05 16:46:18', '/img/songPic/2537672838499056.jpg',
        '[00:00:00]暂无歌词', '/song/武聆音雄 - 太极乐.mp3'),
...
(
    `id`           int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
    `title`        varchar(255)     NOT NULL default '' COMMENT '歌单主题',
    `pic`          varchar(255)     NOT NULL default '' COMMENT '歌单图片',
    `introduction` text COMMENT '简介',
    `style`        varchar(10)      NOT NULL default '无' COMMENT '歌单风格',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 85
  DEFAULT CHARSET = utf8 COMMENT '歌单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
VALUES (1, 'The Good, the Bad and the Ugly', '/img/songListPic/a32415ca9a21f6f9a1d99b2731f224b5d319c424.jpg',
       ...
       (37, '我们的心如此自由 思绪辽远无边', '/img/songListPic/109951163932838310.jpg',
        '我想每个人的心底，都潜藏着一个向往远方的梦，此处已无再多风景，熟悉的地方也不再有惊喜。人心思动，都渴望去流浪天涯，无论以哪种方式。', '欧美'),
       ...
       (46, '性欲与孤独，容易让人误解爱情', '/img/songListPic/109951163924312766.jpg',
        '平常拍片子时，我喜欢在拍摄现场放一些有画面感的音乐让模特找感觉，抽空整理了一下近期的播放列表，做了这套新歌单，或许适合姑娘们在以下一些场景聆听', '轻音乐'),
       ...
       (73, '听说，钢琴和民谣也很搭配', '/img/songListPic/109951163503924397.jpg',
        '我们始终会远行，也可能，在最遥远最陌生的地方感知另一个自己，最后发现丢失了好久的钥匙就藏在自己的口袋里', '乐器-轻音乐'),
       ...
       (83, '国风传统器乐赏~~♪', '/img/songListPic/18907201951803673.jpg',
        '中国音乐是光辉灿烂的中国文化的一个重要组成部分。当古典音乐流泻而出的一刹那间，你可以清楚的看到，在空气中流动的是高山、是流水、是丝竹、是冬雪、是千古的生命，那份说不出、道不尽的感动，就是中国古典音乐之美。', '乐器'),
